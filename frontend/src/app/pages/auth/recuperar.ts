...
@Component({
        ...
        <div class="spa-auth-wrapper">
            ...
            <div class="spa-auth-right">
                <div class="spa-login-card animate-fade-in">
                    ...
                    @if (exitoMensaje()) {
                        <div class="spa-alert spa-alert-exito animate-bounce-in">
                    ...
                    >
                        <ng-template pTemplate="icon">
                            <i class="pi pi-send mr-2" *ngIf="!cargando()"></i>
    ...
    styles: [`
        ...
        .spa-alert-exito { background: #f0fdf4; color: #16a34a; border: 1px solid #dcfce7; }
        .spa-field {
            margin-bottom: 1.5rem;
        }
        .spa-field label {
